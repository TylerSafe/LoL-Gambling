...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ljl.setGeometry(QtCore.QRect(770, 240, 111, 51))
        self.ljl.setObjectName("ljl")
        self.ldl = QtWidgets.QPushButton(self.page)
        self.ldl.setGeometry(QtCore.QRect(770, 150, 111, 51))
        self.ldl.setObjectName("ldl")
        self.nlc = QtWidgets.QPushButton(self.page)
        self.nlc.setGeometry(QtCore.QRect(770, 330, 111, 51))
        self.nlc.setObjectName("nlc")
        self.lfl = QtWidgets.QPushButton(self.page)
        self.lfl.setGeometry(QtCore.QRect(950, 150, 111, 51))
        self.lfl.setObjectName("lfl")
        self.lplol = QtWidgets.QPushButton(self.page)
        self.lplol.setGeometry(QtCore.QRect(950, 240, 111, 51))
        self.lplol.setObjectName("lplol")
        self.hpm = QtWidgets.QPushButton(self.page)
        self.hpm.setGeometry(QtCore.QRect(950, 330, 111, 51))
        self.hpm.setObjectName("hpm")
        self.ul_4 = QtWidgets.QPushButton(self.page)
        self.ul_4.setGeometry(QtCore.QRect(1130, 150, 111, 51))
        self.ul_4.setObjectName("ul_4")
        self.ul_5 = QtWidgets.QPushButton(self.page)
        self.ul_5.setGeometry(QtCore.QRect(1130, 240, 111, 51))
        self.ul_5.setObjectName("ul_5")
        self.ul_6 = QtWidgets.QPushButton(self.page)
        self.ul_6.setGeometry(QtCore.QRect(1130, 330, 111, 51))
        self.ul_6.setObjectName("ul_6")
        self.stackedWidget.addWidget(self.page)
        self.page_ldl = QtWidgets.QWidget()
        self.page_ldl.setObjectName("page_ldl")
        self.label_102 = QtWidgets.QLabel(self.page_ldl)
        self.label_102.setGeometry(QtCore.QRect(440, 800, 61, 21))
        self.label_102.setObjectName("label_102")
        self.ldl_matches = QtWidgets.QTableWidget(self.page_ldl)
        self.ldl_matches.setGeometry(QtCore.QRect(90, 500, 1141, 281))
        self.ldl_matches.setObjectName("ldl_matches")
        self.ldl_matches.setColumnCount(9)
        self.ldl_matches.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.ldl_matches.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.ldl_matches.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.ldl_matches.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.ldl_matches.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.ldl_matches.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.ldl_matches.setHorizontalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        self.ldl_matches.setHorizontalHeaderItem(6, item)
        item = QtWidgets.QTableWidgetItem()
        self.ldl_matches.setHorizontalHeaderItem(7, item)
        item = QtWidgets.QTableWidgetItem()
        self.ldl_matches.setHorizontalHeaderItem(8, item)
        self.label_103 = QtWidgets.QLabel(self.page_ldl)
        self.label_103.setGeometry(QtCore.QRect(620, 800, 51, 21))
        self.label_103.setObjectName("label_103")
        self.ldl_calculate = QtWidgets.QPushButton(self.page_ldl)
        self.ldl_calculate.setGeometry(QtCore.QRect(840, 790, 141, 41))
        self.ldl_calculate.setObjectName("ldl_calculate")
        self.ldl_stats_table = QtWidgets.QTableWidget(self.page_ldl)
        self.ldl_stats_table.setGeometry(QtCore.QRect(100, 80, 831, 351))
        self.ldl_stats_table.setObjectName("ldl_stats_table")
        self.ldl_stats_table.setColumnCount(8)
        self.ldl_stats_table.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.ldl_stats_table.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.ldl_stats_table.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.ldl_stats_table.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.ldl_stats_table.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.ldl_stats_table.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.ldl_stats_table.setHorizontalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        self.ldl_stats_table.setHorizontalHeaderItem(6, item)
        item = QtWidgets.QTableWidgetItem()
        self.ldl_stats_table.setHorizontalHeaderItem(7, item)
        self.label_104 = QtWidgets.QLabel(self.page_ldl)
        self.label_104.setGeometry(QtCore.QRect(1080, 20, 361, 61))
        self.label_104.setObjectName("label_104")
        self.back_25 = QtWidgets.QPushButton(self.page_ldl)
        self.back_25.setGeometry(QtCore.QRect(10, 30, 91, 41))
        self.back_25.setObjectName("back_25")
        self.ladder_ldl = QtWidgets.QTableWidget(self.page_ldl)
        self.ladder_ldl.setGeometry(QtCore.QRect(1000, 80, 231, 351))
        self.ladder_ldl.setObjectName("ladder_ldl")
        self.ladder_ldl.setColumnCount(2)
        self.ladder_ldl.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.ladder_ldl.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.ladder_ldl.setHorizontalHeaderItem(1, item)
        self.update_ldl = QtWidgets.QPushButton(self.page_ldl)
        self.update_ldl.setGeometry(QtCore.QRect(830, 440, 101, 41))
        self.update_ldl.setObjectName("update_ldl")
        self.ldl_line = QtWidgets.QTextEdit(self.page_ldl)
        self.ldl_line.setGeometry(QtCore.QRect(480, 800, 71, 21))
        self.ldl_line.setObjectName("ldl_line")
        self.label_105 = QtWidgets.QLabel(self.page_ldl)
        self.label_105.setGeometry(QtCore.QRect(440, 20, 361, 61))
        self.label_105.setObjectName("label_105")
        self.ldl_odds = QtWidgets.QTextEdit(self.page_ldl)
        self.ldl_odds.setGeometry(QtCore.QRect(670, 800, 71, 21))
        self.ldl_odds.setObjectName("ldl_odds")
        self.stackedWidget.addWidget(self.page_ldl)
        ...
        #self.ldl.clicked.connect(lambda: self.get_ldl())
        ...
        #self.update_ldl.clicked.connect(lambda: ldl_data())
        ...
        self.ldl_calculate.clicked.connect(lambda: self.calc_ldl())
    ...
    def calc_ldl(self):
        line = float(self.ldl_line.toPlainText())
        odds = float(self.ldl_odds.toPlainText())
        self.load_data('ldl', self.ldl_stats_table, self.page_ldl,'https://lol.fandom.com/wiki/LDL/2022_Season/Spring_Season', self.ladder_ldl, 'https://www.rivalry.com/au/esports/league-of-legends-betting/3292-development-league', self.ldl_matches, line, odds)
    ...
    def get_ldl(self):
        self.load_data('ldl', self.ldl_stats_table, self.page_ldl,'https://lol.fandom.com/wiki/LDL/2022_Season/Spring_Season', self.ladder_ldl, 'https://www.rivalry.com/au/esports/league-of-legends-betting/3292-development-league', self.ldl_matches, 28.5)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ldl.setText(_translate("MainWindow", "LDL"))
        ...
        self.ul_4.setText(_translate("MainWindow", "x"))
        self.ul_5.setText(_translate("MainWindow", "x"))
        self.ul_6.setText(_translate("MainWindow", "x"))
        self.label_102.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt;\">Line:</span></p></body></html>"))
        item = self.ldl_matches.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Match"))
        item = self.ldl_matches.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Date"))
        item = self.ldl_matches.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Line"))
        item = self.ldl_matches.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "G1 Avg"))
        item = self.ldl_matches.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "G1 %"))
        item = self.ldl_matches.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "G1 Value"))
        item = self.ldl_matches.horizontalHeaderItem(6)
        item.setText(_translate("MainWindow", "G2 Avg"))
        item = self.ldl_matches.horizontalHeaderItem(7)
        item.setText(_translate("MainWindow", "G2 %"))
        item = self.ldl_matches.horizontalHeaderItem(8)
        ...
        self.ldl_calculate.setText(_translate("MainWindow", "Calculate"))
        item = self.ldl_stats_table.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Team Name"))
        item = self.ldl_stats_table.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Matches"))
        item = self.ldl_stats_table.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Avg Game 1"))
        item = self.ldl_stats_table.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "% Game 1"))
        item = self.ldl_stats_table.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "Avg Game 2"))
        item = self.ldl_stats_table.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "% Game 2"))
        item = self.ldl_stats_table.horizontalHeaderItem(6)
        item.setText(_translate("MainWindow", "Avg Total"))
        item = self.ldl_stats_table.horizontalHeaderItem(7)
        ...
        item = self.ladder_ldl.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Team"))
        item = self.ladder_ldl.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Record"))
        self.update_ldl.setText(_translate("MainWindow", "Update"))
        self.label_105.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:16pt;\">LDL Statistics</span></p></body></html>"))
